...
if __name__ == '__main__':
    ...
    # encoded_data: AutoEncoder轉譯出來的圖片向量, shape(200, 3), type: torch.float32
    encoded_data, _ = autoencoder(view_data)
    fig = plt.figure(2)  # figure number
    ...
    plt.show()
    # torch.save(autoencoder.state_dict(), 'autoencoder_params_date.pkl')  # 存檔(僅存參數)
